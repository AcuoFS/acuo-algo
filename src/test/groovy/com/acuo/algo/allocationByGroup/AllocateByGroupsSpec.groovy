...
class AllocateByGroupsSpec extends Specification implements RenjinEval {
  static {
  ...
  void "AllocateByGroups no pre-allocation" (){
    when:
    ...
    eval('result_mat <- AllocateByGroups(configurations,callInfo_df,availAsset_df,resource_df,\n' +
      '                             pref_vec,operLimitMs,fungible,\n' +
      '                             algoVersion,controls,ifNewAlloc,list(),\n' +
