...
public class LpSolveTest {
    ...
    public void testLpSolve() {
        try {
            ...
            problem.setVerbose(LpSolve.NEUTRAL);
    ...
    @Test public void testMakeLp() throws Exception {
    ...
    @Test public void testTwoProblems() throws Exception {
    ...
    @Test public void testReadWriteLp() throws Exception {
    ...
    @Test public void testReadWriteLpNative() throws Exception {
    ...
    @Test public void testReadWriteMps() throws Exception {
    ...
    @Test public void testReadWriteFreeMps() throws Exception {
    ...
    // API call copy_lp doesn't work yet. Test is useless */
        /*
	@Test public void testCopyLp() throws Exception {
		LpSolve problem = setupProblem();
	...
	/*
	@Test public void testDualizeLp() throws Exception {
		LpSolve problem = setupProblem();
	...
	*/
    ...
    @Ignore
    @Test public void testReadWriteXLI_CPLEX() throws Exception {
        readWriteXLI("CPLEX");
    }

    @Ignore
    @Test public void testReadWriteXLI_LINDO() throws Exception {
        readWriteXLI("LINDO");
    }

	/* Not used, because xli_LPFML is currently not available on LInux
	 * and requires additional lis (Xerces , ..)
	@Test public void testReadWriteXLI_LPFML() throws Exception {
		readWriteXLI("LPFML");
	}
	*/

	/* Not used, because xli_MathProg cannot write models
	@Test public void testReadWriteXLI_MathProg() throws Exception {
		readWriteXLI("MathProg");
	}
	*/

    @Ignore
    @Test public void testSetXLI_Unknown() throws Exception {
    ...
    @Ignore
    @Test public void testHasXLI() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
    ...
    @Test public void testresizeLp() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
        problem.resizeLp(4, 5);
        problem.deleteLp();
    }

    @Test public void testAddColumnex() throws Exception {
    ...
    @Test public void testSetColumn() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 0);
    ...
    @Test public void testSetColumnex() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 0);
        problem.strAddColumn("1 2 3 4");
        assertEquals(1, problem.getNcolumns());
        double[] col = problem.getPtrColumn(1);
    ...
    @Test public void testSetRowex() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("1 2 3 4", LpSolve.LE, 4);
        double[] ptrRow = problem.getPtrRow(1);
        assertEquals(1+4, ptrRow.length);
    ...
    @Test public void testGetSetBasiscrash() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
    ...
    @Test public void testGetSetBbDepthlimit() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
    ...
    @Test public void testGetSetSimplextype() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
    ...
    @Test public void testSetPreferdual() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
    ...
    @Test public void testGetSetScalelimit() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
    ...
    @Test public void testGetStatustext() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
        problem.setVerbose(LpSolve.IMPORTANT);
    ...
    @Ignore
    @Test public void testSetBFP() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
    ...
    @Test public void testSetBFPException() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
        try {
    ...
    @Test public void testSetUnbounded() throws Exception {
    ...
    @Test public void testIsNegative() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 2);
    ...
    @Test public void testGetSetUpbo() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 2);
    ...
    @Test public void testGetSetLowbo() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 2);
    ...
    @Test public void testSetBounds() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 2);
    ...
    @Test public void testWriteDebugdump() throws Exception {
    ...
    @Test public void testSetOutputfile() throws Exception {
    ...
    @Test public void testPrintSolution() throws Exception {
    ...
    @Test public void testPrintTableau() throws Exception {
    ...
    @Test public void testPrintStr() throws Exception {
    ...
    @Test public void testSetObj() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
        problem.strSetObjFn("2 3 -2 3");
    ...
    @Test public void testGetRowex() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strSetObjFn("2 3 -2 3");
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
    ...
    @Test public void testGetColumn() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strSetObjFn("2 3 -2 3");
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
    ...
    @Test public void testGetColumnex() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strSetObjFn("2 3 -2 3");
    ...
    @Test public void testMinimMaxim() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testAddDelConstraint() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testAddConstraintex() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        assertEquals(0, problem.getNrows());
    ...
    @Test public void testGetNonzeros() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testSetObjFn() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testSetObjFnex() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
	...
	@Test public void testAddLagConstraint() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
	...
	*/
    ...
    @Test public void testAddDelColumn() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 0);
        assertEquals(0, problem.getNcolumns());
    ...
    @Test public void testDelColumnWithException() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
        try {
            problem.delColumn(1);
    ...
    @Test public void testColumnInLp() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 0);
    ...
    @Test public void testGetSetLpName() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetRowName() throws Exception {
    ...
    @Test public void testGetSetColName() throws Exception {
    ...
    @Test public void testGetSetMat() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetVerbose() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetTimeout() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetPrintSol() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetDebug() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetTrace() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetLagTrace() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testSetAddRowmode() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testSetAddRowmode2() throws Exception {
    ...
    @Test public void testGetSetAntiDegen() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetPresolve() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetPresolveloops() throws Exception {
        LpSolve problem = setupProblem();
    ...
    @Test public void testGetSetMaxpivot() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetBbRule() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetObjBound() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetFloorFirst() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetSetUseNames() throws Exception {
        LpSolve problem = LpSolve.makeLp(3, 4);
    ...
    @Test public void testGetObjectiveGetSolution() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
        problem.strSetObjFn("2 3 -2 3");
    ...
    @Test public void testPrimalSolution() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
        double[] objFn = { 0, 2, 3, -2, 3 };
    ...
    @Test public void testVarDualresult() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
    ...
    @Test public void testGetPtrVariables() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
        problem.strSetObjFn("2 3 -2 3");
    ...
    @Test public void testGetVariables() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
        problem.strSetObjFn("2 3 -2 3");
    ...
    @Test public void testGetPtrConstraints() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
        problem.strSetObjFn("2 3 -2 3");
    ...
    @Test public void testGetConstraints() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
        problem.strSetObjFn("2 3 -2 3");
    ...
    @Test public void testRhVec() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
    ...
    @Test public void testRh() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
        assertEquals(4.0, problem.getRh(1), 1e-8);
    ...
    @Test public void testConstrType() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
	...
	/*
	@Test public void testAddSOS() throws Exception {
		LpSolve problem = LpSolve.makeLp(0, 4);
		int[] vars = { 2, 3 };
	...
	*/
    ...
    @Test public void testRhRange() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
        problem.strAddConstraint("0 4 3 1", LpSolve.GE, 3);
    ...
    @Test public void testSemicont() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testInfinite() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testEpsint() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testEpsb() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testEpsd() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testEpsel() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testEpspivot() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testEpsperturb() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
	...
	/*
	@Test public void testEpslevel() throws Exception {
		LpSolve problem = setupProblem();
		problem.setVerbose(LpSolve.IMPORTANT);
		problem.solve();
	...
	*/
    ...
    @Test public void testMipGap() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testVarBranch() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testVarWeights() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 2);
    ...
    @Test public void testBreakAtFirst() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testBreakAtValue() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testImprove() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testPivoting() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testNegrange() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testGetSensitivityRhs() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 2);
    ...
    @Test public void testGetDualSolution() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 2);
        problem.strSetObjFn("1 1");
        problem.strAddConstraint("2 4", LpSolve.GE, 10);
        problem.setLowbo(1, 1);
    ...
    @Test public void testGetSensitivityObj() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 2);
        problem.strSetObjFn("1 1");
        problem.strAddConstraint("2 4", LpSolve.GE, 10);
        problem.setLowbo(1, 1);
    ...
    @Test public void testGetSensitivityObjex() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 2);
        problem.strSetObjFn("1 1");
        problem.strAddConstraint("2 4", LpSolve.GE, 10);
        problem.setLowbo(1, 1);
    ...
    @Test public void testIsConstrType() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        problem.strAddConstraint("3 2 2 1", LpSolve.LE, 4);
    ...
    @Test public void testGetSolutioncount() throws Exception {
    ...
    @Test public void testGetSolutionlimit() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
    ...
    @Test public void testGetTotalIter() throws Exception {
        // not a real test but at least we make sure the
        // function exists and does not crash ..
        LpSolve problem = LpSolve.makeLp(0, 0);
        problem.setVerbose(LpSolve.IMPORTANT);
    ...
    @Test public void testGetSetBoundsTighter() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 0);
    ...
    @Test public void testGetLpIndex() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 1);
        assertEquals(1, problem.getLpIndex(1));
        problem.deleteLp();
    }

    @Test public void testIsFeasible() throws Exception {
    ...
    @Test public void testTimeElapsed() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 1);
        problem.setVerbose(LpSolve.IMPORTANT);
        problem.solve();
        problem.timeElapsed();
    ...
    @Test public void testGetNameindexWithRows() throws Exception {
    ...
    @Test public void testGetNameindexWithCols() throws Exception {
        LpSolve problem = LpSolve.makeLp(2, 4);
    ...
    @Test public void testReadNonexistentBasis() throws Exception {
    ...
    @Test public void testReadWriteBasis() throws Exception {
        String filename = "model.bas";
        File file = new File(filename);
        if (file.exists()) file.delete();
        LpSolve problem = LpSolve.makeLp(0, 4);
    ...
    @Test public void testReadWriteParams() throws Exception {
    ...
    @Test public void testResetParams() throws Exception {
        LpSolve problem = LpSolve.makeLp(0, 4);
        assertEquals(250, problem.getMaxpivot());
        problem.setMaxpivot(400);
        assertEquals(400, problem.getMaxpivot());
    ...
    @Test public void testAbortListener() throws Exception {
    ...
    @Test public void testMsgListener() throws Exception {
        final LpSolve problem = LpSolve.makeLp(0, 4);
        class MyListener implements MsgListener {
            public int  numCalls = 0;
            @Test public void msgfunc(LpSolve prob, Object handle, int code) throws LpSolveException {
                numCalls++;
                assertEquals(problem, prob);
                assertEquals(new Integer(123), handle);
    ...
    @Test public void testLogListener() throws Exception {
        ...
        class MyListener implements LogListener {
            public int  numCalls = 0;
            @Test public void logfunc(LpSolve prob, Object handle, String buf) {
                numCalls++;
                assertEquals(problem, prob);
                assertEquals(new Integer(123), handle);
                assertNotNull(buf);
