AllocationScenario1 <- function(configurations,callInfo_df,availAsset_df,resource_df,pref_vec,operLimitMs,fungible,
  ...
  result <- AllocateByGroups(configurations,callInfo_df,availAsset_df,resource_df,
...
AllocationScenario2 <- function(configurations,callInfo_df,availAsset_df,resource_df,pref_vec,operLimitMs,fungible,
                                algoVersion,controls,ifNewAlloc,allocated_list,minMoveValue,timeLimit,maxCallNum,maxMsNum,callOrderMethod){
...
AllocationScenario3 <- function(configurations,callInfo_df,availAsset_df,resource_df,pref_vec,operLimitMs,fungible,
                                algoVersion,controls,ifNewAlloc,allocated_list,minMoveValue,timeLimit,maxCallNum,maxMsNum,callOrderMethod){
